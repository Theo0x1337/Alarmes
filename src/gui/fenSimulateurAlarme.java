	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().toString() == "comboBoxChanged") {
	        ...
	        if(getType.equals("Gaz")) {
	        	//Si on s�lectionne un �venement Gaz on ajoute au formulaire une entr� de texte pour renseigner le type de gaz
	        	left.removeAll();
	        	...
	        	//Si on s�lectionne un �venement Radiation on ajoute au formulaire une entr� de texte pour renseigner le niveau de radiation compris entre 0-100
	        	left.removeAll();
